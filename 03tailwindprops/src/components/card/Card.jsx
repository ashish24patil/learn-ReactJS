...
function Card({name, btnText="Click me!", desc="This is Description"}) {
    return (
        <>
            <div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group mt-5 ml-5cd">
